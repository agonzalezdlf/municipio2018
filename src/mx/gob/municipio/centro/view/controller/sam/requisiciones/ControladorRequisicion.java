...
*/
	...
	public String  requestGetControlador( Map modelo, HttpServletRequest request) {
		...
		modelo.put("CLV_UNIMED",gatewayUnidadMedidas.getUnidadMedidasTodas());
		...
		String json = gson.toJson(gatewayBeneficiario.getShortVendor());
	...
	public List<Map>getUnidadMedidas(){
