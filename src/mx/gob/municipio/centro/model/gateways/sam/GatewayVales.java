...
public class GatewayVales  extends BaseGateway {
	...
	/*Metodo usado para determinar si se guarda un nueva vale o se actualiza una existente*/
	public  Long actualizarVales(Long clave,Date fecha,String  tipoVale,String claveBeneficiario,String justificacion,Integer mes,Date fechaInicial,Date fechaFinal,Date fechaMaxima,String documentacion, Long cve_contrato, Integer ejercicio, Integer idUsuario , int  claveUnidad, int idrecurso,Integer idGrupo){
	...
	public Long guardar( Date fecha,String  tipoVale,String claveBeneficiario,String justificacion,/*String proyecto, String partida,*/
		Integer mes,Date fechaInicial,Date fechaFinal,Date fechaMaxima,String documentacion, Long cve_contrato, Integer ejercicio, Integer idUsuario , Integer  claveUnidad ,int idrecurso, Integer idGrupo  ) {
	...
	/*Metodo para actualizar los datos del vale*/
	public void actualizar( Long clave,Date fecha,String  tipoVale,String claveBeneficiario,String justificacion,/*String proyecto, String partida,*/
		Integer mes,Date fechaInicial,Date fechaFinal,Date fechaMaxima,String documentacion, Long cve_contrato, String numVale, Integer ejercicio, Integer idUsuario , Integer  claveUnidad ,int idrecurso, Integer id_grupo){
	...
	/*-------  Este procedimiento incluye el Cerrado de vales -------------*/
	public void actualizarEstatusVale( Long clave, Integer idStatus, Integer ejercicio, Integer cve_pers){
		...
		if(idStatus==1){
			this.getJdbcTemplate().update("UPDATE SAM_VALES_EX set  STATUS=?,FECHA_CIERRE=?  where CVE_VALE=? ", new Object[]{1,fecha_actual,clave});
			...
			int status =this.getJdbcTemplate().queryForInt("SELECT STATUS FROM SAM_VALES_EX WHERE CVE_VALE =?", new Object[]{clave});
		}	
			
		if(idStatus==2)
		{
			Scerrado = this.getJdbcTemplate().queryForInt("SELECT COUNT (CVE_VALE) FROM SAM_VALES_EX WHERE FECHA_CIERRE IS NOT NULL AND CVE_VALE =?", new Object[]{clave});
			if (Scerrado == 1 )
				this.getJdbcTemplate().update("UPDATE SAM_VALES_EX set  STATUS=?,FECHA_CANCELADO=? where CVE_VALE=? ", new Object[]{2,fecha_actual,clave});
			else
				this.getJdbcTemplate().update("UPDATE SAM_VALES_EX set  STATUS=? where CVE_VALE=? ", new Object[]{2,clave});
		...
		if(idStatus==4)
		{
			...
			this.getJdbcTemplate().update("UPDATE SAM_VALES_EX set  STATUS=? where CVE_VALE=? ", new Object[]{4,clave});
		}	
		if(idStatus==5){
