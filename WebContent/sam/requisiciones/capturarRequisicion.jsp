...
<script>
var JsonBenefi = JSON.parse('${jsonbebefi}');

//alert(JsonBenefi[0].label + ' > ' + JsonBenefi[0].value);
var availableTags = JsonBenefi;
</script>
	...
	<div class="panel with-nav-tabs panel-primary">
		<div class="panel-heading">
	 		<ul class="nav nav-tabs responsive">
                ...
                <li><a href="#tab-conceptos" data-toggle="tab" id="lotes">Lotes</a></li>
         	</ul>
		 	 			...
		 	 			<form class="form-horizontal">
			                  ...
			                  <div class="row" style="border-bottom:10px">
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-2">
										<input placeholder="Requisición" type="text" value="" name="txtrequisicion" required title="Se necesita un número de requisición" id="txtrequisicion"  style="margin-bottom: 8px;" class="form-control sm" maxlength="16" onBlur="upperCase(this)"/>
									</div>
									<label class="control-label col-sm-1" for="txtfecha">*Fecha:</label>
									<div class="col-sm-2">
									  	<input placeholder="Fecha" type="text" id="txtfecha"  name="txtfecha" class="form-control sm" maxlength="10" style="text-align:center;" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${xfecha}" />" />
									</div>
			                ...
			                <!--Notas-->
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="form-group col-sm-5">
			                            <textarea id="txtnotas" rows="3" class="form-control sm" wrap="virtual" style="margin-top:10px;" maxlength="400"></textarea>
			                        </div>
			                    </div>
			                  </div> 
				                  ...
				                  <div class="row" id="fila_disponibleVale">
				                    <div class="form-group">
				                        <div class="control-label col-sm-3 ">Total del Vale:</div>
				                      		<div class="col-sm-2">
												<input type="text" placeholder="txtpresupuesto" name="txtpresupuesto" id="txtpresupuesto" class="form-control sm" disabled="disabled" style="margin-bottom: 8px;" />
											</div>
			                ...
			                <div id="div_os_vehiculo"><!--div_os_vehiculo-->  
			                  ...
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-2">
			                           	<input type="text" placeholder="Placas" id="txtplacas" maxlength="10" class="form-control sm" style="width:150px;margin-bottom: 8px;" />
			                        </div>
										<!-- <label class="control-label col-sm-1" for="txtproyecto">Marca::</label> -->
										<div class="col-sm-1">
											<input type="text" placeholder="Color" id="txtcolor" maxlength="15" class="form-control sm" style="width:100px" />
										</div>
										<!-- <label class="control-label col-sm-1" for="cbomeses">Modelo:</label> -->
										<div class="col-sm-2">
											<!--<label class="control-label col-sm-1" for="cbomeses">*Area:</label>-->
											<select name="cboarea" id="cboarea" class="selectpicker form-control input-sm m-b" title="Area de revisón" style="width:155px">
			                  ...
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="form-group col-sm-3">
										...
										<div class="col-sm-2">
											<input placeholder="Concurso" type="text" id="txtconcurso" class="form-control sm" style="width:130px" />
										</div>
								</div>
			                  </div>   
			                   <!--Descripción por autocomplete-->
			                    <!-- <div class="row">
			                    <div class="form-group">
			                     	<div class="control-label col-sm-3 ">Prestador del servicio:</div>
			                        <div class="container">
									  <div class="form-group">
									    ...
									    <input class="form-control autocomplete" name="txtbeneficiario" id="txtbeneficiario" value="${item.NCOMERCIA}" placeholder="Capture el beneficiario" />
									  </div>
									</div>
								</div>
			                  </div>  -->	
			              ...
			              <!--Tipo de bien-->
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-2">
			                           	<input type="text" placeholder="Tipo de bien" id="txttipobien"  maxlength="15" class="form-control sm" style="width:200px;margin-bottom: 8px;"/>
			                           </div>
										<!-- <label class="control-label col-sm-1" for="txtproyecto">Marca::</label> -->
										<div class="col-sm-2">
											<input type="text" placeholder="Marca" id="txtmarca" class="form-control sm" maxlength="15" style="width:200px" />
										</div>
										<!-- <label class="control-label col-sm-1" for="cbomeses">Modelo:</label> -->
										<div class="col-sm-2">
											<input type="text" placeholder="Modelo" id="txtmodelo" maxlength="20" class="form-control sm" style="width:130px" />
										</div>
			                     </div>
			                  </div> 
			                   <!--Usuario, Num. Invent-->
				                  <div class="row" style="border-bottom:15px !important;">
				                    <div class="form-group">
				                        <div class="control-label col-sm-3 ">Usuario:</div>
				                         	<div class="col-sm-2">
				                         		<input type="text" placeholder="Usuario responsable" id="txtusuario" maxlength="50" class="form-control sm"/>
											</div>
											<label class="control-label col-sm-1" for="txtproyecto">Num. Invent:</label>
											<div class="col-sm-2">
												<input type="text" placeholder="No. de Inventario" id="txtnuminventario" class="form-control sm" />
											</div>
				                     </div>
				                  </div> 
	                  ...
	                  <div class="row">
	                    <div class="form-group">
	                        <div class="control-label col-sm-3">*Artículo/Producto/Servicio:&nbsp;</div>
	                      		<div class="col-sm-3">
									 <input name="txtproducto" type="text" class="form-control sm" id="txtproducto" value="" placeholder="Articulo"/>
								...
								<div class="col-sm-2">
									<!--<sec:authorize ifNotGranted="ROLE_Sam_PRIVILEGIOS_CAMBIAR_PRECIO_REQUISICIONES">
										...
										<input name="txtprecioestimado" type="text" class="form-control sm" id="txtprecioestimado" value="" placeholder="Precio estimado"/>
								</div>
	                    </div>
	                  </div>
    	        <!--Artículo, Precio-->
	                  <div class="row">
	                    <div class="form-group">
	                        <div class="control-label col-sm-3 ">*Unidad de Medida:&nbsp;</div>
	                      		<div class="col-sm-3">
	                      			<select class="selectpicker form-control input-sm" data-live-search="true" style="width:100%" id="cbounimed" name="cbounimed" title="Unidad de medida...">
											<c:forEach items="${unidadesmedida}" var="item" varStatus="status">
												<option value='<c:out value="${item.CLV_UNIMED}"/>'
												<c:if test='${item.CLV_UNIMED==cbounimed}'>selected</c:if>><c:out value='${item.unidmedida}'/>
												</option>
											</c:forEach>    
									</select>
								...
								<div class="col-sm-2">
									<input type="text" value="" id="txtcantidad" class="form-control sm" placeholder="Cantidad" />
								</div>
	                    </div>
	                  </div>
                <!--Descripción-->
	                  <div class="row">
	                    <div class="form-group">
	                        <div class="control-label col-sm-3 ">*Descripción:&nbsp;</div>
	                      		<div class="col-sm-6">
									<textarea id="txtdescripcion" name="txtdescripcion" rows="4" class="form-control sm" placeholder="Descripcion anexa del articulo..." wrap="virtual" maxlength="300"></textarea>
								</div>
						</div>
	                  </div>     
           		<!--Nuevo lote-->
