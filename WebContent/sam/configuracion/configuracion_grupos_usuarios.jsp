...
<script type="text/javascript" src="configuracion_grupos_usuarios.js?x=<%=System.currentTimeMillis()%>"></script>
    ...
    <tr>
      ...
      <td><table width="100%"  border="0" align="center"  cellpadding="0" cellspacing="0" class="table table-hover table table-condensed"  id="detallesTabla" >
        <thead class="thead-inverse">
          <tr >
            <th width="7%" height="20"><input type="checkbox" name="todos" id="todos"></th>
