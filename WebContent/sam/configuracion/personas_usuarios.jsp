...
<script type="text/javascript" src="../../include/js/jquery-1.6.min.js"></script>
...
<br />
  ...
  <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="formulario">
    ...
    <tr>
      ...
      <td><input  name="btnBuscar" type="button"  class="botones" id="btnBuscar" value="Buscar" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3"><input type="button"  class="botones"  name="btnGrabar" value="Guardar" />
      <input type="button"  class="botones"  name="btnlimpiar" value="Nuevo"  /></td>
    </tr>
    <tr>
